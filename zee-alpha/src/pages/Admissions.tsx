...
const admissionSteps = [
  {
    ...
    details: {
      ...
      requirements:
        "Form includes student information, parent/guardian details, and academic history",
  ...
  },
  {
    ...
    details: {
      ...
      orientation:
        "New student and parent orientation before school resumption",
    },
  },
];
          ...
          <div className=" items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Welcome to Zee-Alpha
              </h2>
              <div className="w-20 h-1 bg-gradient-to-r from-red-600 to-red-500 rounded-full mb-8"></div>

              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  At Zee-Alpha International Schools, we believe every child
                  deserves access to quality education that nurtures their
                  unique talents and prepares them for global citizenship. Our
                  admissions process is designed to be transparent, supportive,
                  and focused on finding students who will thrive in our dynamic
                  learning environment.
                </p>

                <p>
                  We welcome applications from students of all backgrounds who
                  demonstrate academic potential, good character, and a
                  willingness to contribute positively to our school community.
                  Our rolling admissions policy ensures we can accommodate
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined 4-step process ensures a smooth transition into
              the Zee-Alpha family
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-red-600 to-red-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Join our community of learners, innovators, and future leaders. Take
            the first step toward an exceptional educational experience.
          </p>
