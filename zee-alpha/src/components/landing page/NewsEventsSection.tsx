...
const events = [
  {
    ...
    description:
      "Celebrating diversity with cultural performances, traditional foods, and international exhibitions from our students.",
    category: "Cultural",
  },
  {
    ...
    description:
      "Showcasing student projects in robotics, renewable energy, and scientific research breakthroughs.",
    category: "Academic",
  },
  {
    ...
    description:
      "Annual inter-house sports competition featuring track events, football finals, and athletic achievements.",
    category: "Sports",
  },
];
