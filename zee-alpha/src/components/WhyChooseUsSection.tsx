      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            At Zee-Alpha, education goes beyond textbooks, we nurture curious minds and build future leaders.
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-4xl mx-auto leading-relaxed">
              Our unique curriculum blends the Nigerian National Curriculum with the British Curriculum, 
              ensuring students gain both local grounding and international relevance.
            </p>
          </div>
              ...
              >
                ...
                <div className="relative h-full flex flex-col justify-end p-6 text-white">
                  ...
                  <div className="mb-4">
                    ...
                    <h4 className="text-xl font-semibold text-center">{level.title}</h4>
                  </div>
