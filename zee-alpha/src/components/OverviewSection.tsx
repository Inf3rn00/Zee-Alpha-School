  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 w-48 h-48 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-20 left-1/3 w-52 h-52 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{animationDelay: '4s'}}></div>
            ...
            <div className="space-y-4">
              <div className="inline-block">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-red-600 font-semibold uppercase tracking-widest text-lg">Welcome</span>
                </div>
              </div>
              <h2 className="text-2xl  font-bold leading-tight">
                ...
                <span className="block text-gray-800"> International Schools</span>
              </h2>
            </div>
              ...
              {highlights.map((highlight, index) => (
                <div key={index} className="flex items-start space-x-4 group">
                  <div className="flex-shrink-0 mt-1">
                    <CheckCircle className="text-red-600 group-hover:text-red-700 transition-colors" size={24} />
                  </div>
                  <span className="text-gray-700 text-lg group-hover:text-gray-900 transition-colors font-medium">{highlight}</span>
                </div>
              ))}
            </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-2xl p-6 w-50 border border-gray-100 backdrop-blur-sm bg-opacity-95">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-green-600 font-semibold text-sm">Academic Distinction</span>
              </div>
            </div>
          </div>
        </div>
