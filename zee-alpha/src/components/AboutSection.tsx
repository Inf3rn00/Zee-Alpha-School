...
export function AboutSection() {
  return (
    <section id="about" className="relative py-24 bg-gradient-to-b from-[#1E3A8A] via-[#1e40af] to-[#1E3A8A] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="inline-block mb-4">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-white font-semibold uppercase tracking-widest text-4xl">About Our School</span>
              <div className="h-1 w-8 bg-red-600 rounded-full"></div>
            </div>
          </div>
        ...
        <div>
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-bold mb-4">Our Core Values</h3>
            <p className="text-blue-100 max-w-2xl mx-auto">The principles that guide everything we do</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {values.map((value, index) => (
              <Card key={index} className="p-6 text-center bg-white/10 backdrop-blur-md border border-white/20 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/20 hover:scale-105 hover:-translate-y-2 group">
        ...
        <div className="mt-20">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-bold mb-4">Meet The Team</h3>
            <p className="text-blue-100 max-w-2xl mx-auto">Dedicated professionals committed to excellence in education</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <Card key={index} className="p-6 text-center bg-white/10 backdrop-blur-md border border-white/20  transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/20 hover:scale-105 group cursor-pointer">
                <div className="relative mb-6">
                  <div className="relative w-20 h-20 rounded-full mx-auto flex items-center justify-center  border-2 border-white/20">
                    {member.image? (
                      <img src={member.image} alt={member.title} className="w-full h-full object-cover rounded-full" />
                    ) : (
